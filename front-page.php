...
<main>
            ...
            <!-- <article class="blog-item"> -->
                ...
                <p><span class="label">Precio:</span> <i class="fas fa-money-bill-wave single-car-icons"></i> <?php the_field('precio')?></p>
                <p><span class="label">Marca:</span> <i class="fas fa-car single-car-icons"></i> <?php the_field('marca')?></p>
                <p><span class="label">Año:</span> <i class="far fa-calendar-alt single-car-icons"></i> <?php the_field('ano')?></p>
                <p><span class="label">Millas:</span> <i class="fas fa-tachometer-alt single-car-icons"></i> <?php the_field('millas')?></p>

                <p class="excerpt"><?php echo wp_trim_words(get_the_content(), 18); ?></p>
                
                <p class="read-more"><a class="cta" href="<?php the_permalink(); ?>">Mas Detalles &raquo;</a></p>
            <!-- </article> -->
